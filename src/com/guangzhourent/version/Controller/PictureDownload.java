...
@WebServlet(name = "PictureDownload",urlPatterns = "/pictureDownload")
public class PictureDownload extends BaseServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        FileInputStream inputStream = new FileInputStream("/usr/local/GuangzhouRent/apartmentImg/"+name);
        if (inputStream != null) {
